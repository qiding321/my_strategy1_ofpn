...
class Paras:
    ...
    @property
    def paras_after_selection_sell(self):
        d = {
            'method': 'test',
            'time_freq': '15s',
            'time_scale_x': '1min',
    ...
    def my_para(self):
        ...
        description = 'rolling_{}_{}_{}_predict_{}_normalized_by_{}_{}_1min{trancate_descrip}{decision_tree_descrip}'.format(
            reg_name,
            method, training_period, testing_period, testing_demean_period,
